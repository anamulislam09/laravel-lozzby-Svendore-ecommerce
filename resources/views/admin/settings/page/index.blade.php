          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{ route('page.create') }}" class="btn btn-sm btn-primary" style="float:right">Add New</a>
              </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="{{route('page.edit',$page->id)}}" class="btn btn-sm btn-info edit"  ><i class="fas fa-edit"></i></a>
                        <a href="{{ route('page.delete', $page->id) }}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                  @endforeach
                  </tbody>
